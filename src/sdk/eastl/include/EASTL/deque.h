...
namespace eastl
{
	...
	///
	template <typename Allocator, typename T, unsigned kDequeSubarraySize>
	struct DequeBase
	{
		typedef T                                                        value_type;
	...
	/// 
	template <typename Allocator, typename T, unsigned kDequeSubarraySize = DEQUE_DEFAULT_SUBARRAY_SIZE(T)>
	class deque : public DequeBase<Allocator, T, kDequeSubarraySize>
	{
	public:
		typedef DequeBase<Allocator, T, kDequeSubarraySize>              base_type;
		typedef deque<Allocator, T, kDequeSubarraySize>                  this_type;
		typedef T                                                        value_type;
		typedef T*                                                       pointer;
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	DequeBase<Allocator, T, kDequeSubarraySize>::DequeBase(const allocator_type& allocator)
		: mpPtrArray(NULL),
		  mnPtrArraySize(0),
		  mItBegin(),
		  mItEnd(),
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	DequeBase<Allocator, T, kDequeSubarraySize>::DequeBase(size_type n)
		: mpPtrArray(NULL),
		  mnPtrArraySize(0),
		  mItBegin(),
		  mItEnd(),
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	DequeBase<Allocator, T, kDequeSubarraySize>::DequeBase(size_type n, const allocator_type& allocator)
		: mpPtrArray(NULL),
		  mnPtrArraySize(0),
		  mItBegin(),
		  mItEnd(),
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	DequeBase<Allocator, T, kDequeSubarraySize>::~DequeBase()
	{
		if(mpPtrArray)
		{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	const typename DequeBase<Allocator, T, kDequeSubarraySize>::allocator_type&
	DequeBase<Allocator, T, kDequeSubarraySize>::get_allocator() const EA_NOEXCEPT
	{
		return mAllocator;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename DequeBase<Allocator, T, kDequeSubarraySize>::allocator_type&
	DequeBase<Allocator, T, kDequeSubarraySize>::get_allocator() EA_NOEXCEPT
	{
		return mAllocator;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void DequeBase<Allocator, T, kDequeSubarraySize>::set_allocator(const allocator_type& allocator)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	T* DequeBase<Allocator, T, kDequeSubarraySize>::DoAllocateSubarray()
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void DequeBase<Allocator, T, kDequeSubarraySize>::DoFreeSubarray(T* p)
	{
		if(p)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void DequeBase<Allocator, T, kDequeSubarraySize>::DoFreeSubarrays(T** pBegin, T** pEnd)
	{
		while(pBegin < pEnd)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	T** DequeBase<Allocator, T, kDequeSubarraySize>::DoAllocatePtrArray(size_type n)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void DequeBase<Allocator, T, kDequeSubarraySize>::DoFreePtrArray(T** pp, size_t n)
	{
		if(pp)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename DequeBase<Allocator, T, kDequeSubarraySize>::iterator
	DequeBase<Allocator, T, kDequeSubarraySize>::DoReallocSubarray(size_type nAdditionalCapacity, Side allocationSide)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void DequeBase<Allocator, T, kDequeSubarraySize>::DoReallocPtrArray(size_type nAdditionalCapacity, Side allocationSide)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void DequeBase<Allocator, T, kDequeSubarraySize>::DoInit(size_type n)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque()
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(const allocator_type& allocator)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(size_type n, const allocator_type& allocator)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(size_type n, const value_type& value, const allocator_type& allocator)
		: base_type(n, allocator)
	{
		DoFillInit(value);
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(const this_type& x)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(this_type&& x)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(this_type&& x, const allocator_type& allocator)
	  : base_type((size_type)0, allocator)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(std::initializer_list<value_type> ilist, const allocator_type& allocator)
		: base_type(allocator)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	inline deque<Allocator, T, kDequeSubarraySize>::deque(InputIterator first, InputIterator last)
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::this_type& 
	deque<Allocator, T, kDequeSubarraySize>::operator=(const this_type& x)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::this_type& 
	deque<Allocator, T, kDequeSubarraySize>::operator=(this_type&& x)
	{
		if(this != &x)
		{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::this_type& 
	deque<Allocator, T, kDequeSubarraySize>::operator=(std::initializer_list<value_type> ilist)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void deque<Allocator, T, kDequeSubarraySize>::assign(size_type n, const value_type& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void deque<Allocator, T, kDequeSubarraySize>::assign(std::initializer_list<value_type> ilist)
	{
		DoAssign(ilist.begin(), ilist.end(), false_type());
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	inline void deque<Allocator, T, kDequeSubarraySize>::assign(InputIterator first, InputIterator last)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::iterator 
	deque<Allocator, T, kDequeSubarraySize>::begin() EA_NOEXCEPT
	{
		return mItBegin;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::const_iterator 
	deque<Allocator, T, kDequeSubarraySize>::begin() const EA_NOEXCEPT
	{
		return mItBegin;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::const_iterator 
	deque<Allocator, T, kDequeSubarraySize>::cbegin() const EA_NOEXCEPT
	{
		return mItBegin;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::iterator 
	deque<Allocator, T, kDequeSubarraySize>::end() EA_NOEXCEPT
	{
		return mItEnd;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::const_iterator
	deque<Allocator, T, kDequeSubarraySize>::end() const EA_NOEXCEPT
	{
		return mItEnd;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::const_iterator
	deque<Allocator, T, kDequeSubarraySize>::cend() const EA_NOEXCEPT
	{
		return mItEnd;
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::rbegin() EA_NOEXCEPT
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::const_reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::rbegin() const EA_NOEXCEPT
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::const_reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::crbegin() const EA_NOEXCEPT
	{
		return const_reverse_iterator(mItEnd);
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::rend() EA_NOEXCEPT
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::const_reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::rend() const EA_NOEXCEPT
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline typename deque<Allocator, T, kDequeSubarraySize>::const_reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::crend() const EA_NOEXCEPT
	{
		return const_reverse_iterator(mItBegin);
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline bool deque<Allocator, T, kDequeSubarraySize>::empty() const EA_NOEXCEPT
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::size_type
	inline deque<Allocator, T, kDequeSubarraySize>::size() const EA_NOEXCEPT
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void deque<Allocator, T, kDequeSubarraySize>::resize(size_type n, const value_type& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void deque<Allocator, T, kDequeSubarraySize>::resize(size_type n)
	{
		resize(n, value_type());
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void deque<Allocator, T, kDequeSubarraySize>::shrink_to_fit()
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void deque<Allocator, T, kDequeSubarraySize>::set_capacity(size_type n)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reference
	deque<Allocator, T, kDequeSubarraySize>::operator[](size_type n)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::const_reference
	deque<Allocator, T, kDequeSubarraySize>::operator[](size_type n) const
	{
		#if EASTL_EMPTY_REFERENCE_ASSERT_ENABLED    // We allow the user to use a reference to v[0] of an empty container.
			if(EASTL_UNLIKELY((n != 0) && n >= (size_type)(mItEnd - mItBegin)))
				EASTL_FAIL_MSG("deque::operator[] -- out of range");
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reference
	deque<Allocator, T, kDequeSubarraySize>::at(size_type n)
	{
		#if EASTL_EXCEPTIONS_ENABLED
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::const_reference
	deque<Allocator, T, kDequeSubarraySize>::at(size_type n) const
	{
		#if EASTL_EXCEPTIONS_ENABLED
			if(n >= (size_type)(mItEnd - mItBegin))
				throw std::out_of_range("deque::at -- out of range");
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reference
	deque<Allocator, T, kDequeSubarraySize>::front()
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::const_reference
	deque<Allocator, T, kDequeSubarraySize>::front() const
	{
		#if EASTL_EMPTY_REFERENCE_ASSERT_ENABLED
			// We allow the user to reference an empty container.
		#elif EASTL_ASSERT_ENABLED
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reference
	deque<Allocator, T, kDequeSubarraySize>::back()
	{
		#if EASTL_EMPTY_REFERENCE_ASSERT_ENABLED
			// We allow the user to reference an empty container.
		#elif EASTL_ASSERT_ENABLED
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::const_reference
	deque<Allocator, T, kDequeSubarraySize>::back() const
	{
		#if EASTL_EMPTY_REFERENCE_ASSERT_ENABLED
			// We allow the user to reference an empty container.
		#elif EASTL_ASSERT_ENABLED
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::push_front(const value_type& value)
	{
		emplace_front(value);
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::push_front(value_type&& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reference
	deque<Allocator, T, kDequeSubarraySize>::push_front()
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::push_back(const value_type& value)
	{
		emplace_back(value);
	}
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::push_back(value_type&& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reference
	deque<Allocator, T, kDequeSubarraySize>::push_back()
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::pop_front()
	{
		#if EASTL_ASSERT_ENABLED
			if(EASTL_UNLIKELY((size_type)(mItEnd == mItBegin)))
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::pop_back()
	{
		#if EASTL_ASSERT_ENABLED
			if(EASTL_UNLIKELY((size_type)(mItEnd == mItBegin)))
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template<class... Args>
	typename deque<Allocator, T, kDequeSubarraySize>::iterator
	deque<Allocator, T, kDequeSubarraySize>::emplace(const_iterator position, Args&&... args)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template<class... Args>
	void deque<Allocator, T, kDequeSubarraySize>::emplace_front(Args&&... args)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template<class... Args>
	void deque<Allocator, T, kDequeSubarraySize>::emplace_back(Args&&... args)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::iterator
	deque<Allocator, T, kDequeSubarraySize>::insert(const_iterator position, const value_type& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::iterator
	deque<Allocator, T, kDequeSubarraySize>::insert(const_iterator position, value_type&& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::insert(const_iterator position, size_type n, const value_type& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	void deque<Allocator, T, kDequeSubarraySize>::insert(const_iterator position, InputIterator first, InputIterator last)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::iterator
	deque<Allocator, T, kDequeSubarraySize>::insert(const_iterator position, std::initializer_list<value_type> ilist)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::iterator
	deque<Allocator, T, kDequeSubarraySize>::erase(const_iterator position)
	{
		#if EASTL_ASSERT_ENABLED
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::iterator
	deque<Allocator, T, kDequeSubarraySize>::erase(const_iterator first, const_iterator last)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::erase(reverse_iterator position)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	typename deque<Allocator, T, kDequeSubarraySize>::reverse_iterator
	deque<Allocator, T, kDequeSubarraySize>::erase(reverse_iterator first, reverse_iterator last)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::clear()
	{
	...
	//template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	//void deque<Allocator, T, kDequeSubarraySize>::reset_lose_memory()
	//{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::swap(deque& x)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename Integer>
	void deque<Allocator, T, kDequeSubarraySize>::DoInit(Integer n, Integer value, true_type)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	void deque<Allocator, T, kDequeSubarraySize>::DoInit(InputIterator first, InputIterator last, false_type)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	void deque<Allocator, T, kDequeSubarraySize>::DoInitFromIterator(InputIterator first, InputIterator last, EASTL_ITC_NS::input_iterator_tag)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename ForwardIterator>
	void deque<Allocator, T, kDequeSubarraySize>::DoInitFromIterator(ForwardIterator first, ForwardIterator last, EASTL_ITC_NS::forward_iterator_tag)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::DoFillInit(const value_type& value)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename Integer>
	void deque<Allocator, T, kDequeSubarraySize>::DoAssign(Integer n, Integer value, true_type) // false_type means this is the integer version instead of iterator version.
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	void deque<Allocator, T, kDequeSubarraySize>::DoAssign(InputIterator first, InputIterator last, false_type) // false_type means this is the iterator version instead of integer version.
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::DoAssignValues(size_type n, const value_type& value)
	{
		const size_type nSize = size();
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename Integer>
	void deque<Allocator, T, kDequeSubarraySize>::DoInsert(const const_iterator& position, Integer n, Integer value, true_type)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	void deque<Allocator, T, kDequeSubarraySize>::DoInsert(const const_iterator& position, const InputIterator& first, const InputIterator& last, false_type)
	{
		typedef typename eastl::iterator_traits<InputIterator>::iterator_category IC;
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	template <typename InputIterator>
	void deque<Allocator, T, kDequeSubarraySize>::DoInsertFromIterator(const_iterator position, const InputIterator& first, const InputIterator& last, EASTL_ITC_NS::forward_iterator_tag)
	{
		const size_type n = (size_type)eastl::distance(first, last);
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	void deque<Allocator, T, kDequeSubarraySize>::DoInsertValues(const_iterator position, size_type n, const value_type& value)
	{
		#if EASTL_ASSERT_ENABLED
			if(EASTL_UNLIKELY(!(validate_iterator(position) & isf_valid)))
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void deque<Allocator, T, kDequeSubarraySize>::DoSwap(this_type& x)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline bool deque<Allocator, T, kDequeSubarraySize>::validate() const
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline int deque<Allocator, T, kDequeSubarraySize>::validate_iterator(const_iterator i) const
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline bool operator==(const deque<Allocator, T, kDequeSubarraySize>& a, const deque<Allocator, T, kDequeSubarraySize>& b)
	{
	...
	template<typename Allocator, typename T, unsigned kDequeSubarraySize>
	inline void swap(deque<Allocator, T, kDequeSubarraySize>& a, deque<Allocator, T, kDequeSubarraySize>& b)
	{
		a.swap(b);
	}
