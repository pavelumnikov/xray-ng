...
template <typename Allocator,
    ...
    using unordered_map = hash_map<Allocator, Key, T, Hash, Predicate, bCacheHashCode>;
#endif
...
template <typename Allocator,
    ...
    typename Predicate = eastl::equal_to<Key>,
    bool bCacheHashCode = false>
    using unordered_multimap = hash_multimap<Allocator, Key, T, Hash, Predicate, bCacheHashCode>;
#endif
