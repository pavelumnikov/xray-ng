...
namespace eastl
{
	...
	/// preserved.
	template<typename Allocator, typename ForwardIterator, typename Predicate>
	ForwardIterator stable_partition(Allocator& allocator, ForwardIterator first, ForwardIterator last, Predicate pred)
	{
	...
	///
	template<typename Allocator, typename RandomAccessIterator, typename StrictWeakOrdering>
	void stable_sort(Allocator& allocator, RandomAccessIterator first, RandomAccessIterator last, StrictWeakOrdering compare)
	{
		...
		#else
			eastl::merge_sort<RandomAccessIterator, Allocator, StrictWeakOrdering>
							 (first, last, allocator, compare);
		#endif
	}

	template<typename Allocator, typename RandomAccessIterator>
	void stable_sort(Allocator& allocator, RandomAccessIterator first, RandomAccessIterator last)
	{
		#if defined(EASTL_DEFAULT_STABLE_SORT_FUNCTION)
			EASTL_DEFAULT_STABLE_SORT_FUNCTION(first, last, *get_default_allocator(0));
		#else
			eastl::merge_sort<RandomAccessIterator, Allocator>
