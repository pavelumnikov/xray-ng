...
class fixed_vector : public vector<T, fixed_vector_allocator<sizeof(T), nodeCount, EASTL_ALIGN_OF(T), 0> >
{
public:
    ...
    typedef fixed_vector<T, nodeCount> this_type;
...
template <typename T, size_t nodeCount>
inline fixed_vector<T, nodeCount>::fixed_vector()
...
template <typename T, size_t nodeCount>
inline fixed_vector<T, nodeCount>::fixed_vector(size_type n)
    : base_type(fixed_allocator_type(mBuffer.buffer))
{
#if EASTL_NAME_ENABLED
    get_allocator().set_name(EASTL_FIXED_VECTOR_DEFAULT_NAME);
...
template <typename T, size_t nodeCount>
inline fixed_vector<T, nodeCount>::fixed_vector(size_type n, const value_type& value)
    : base_type(fixed_allocator_type(mBuffer.buffer))
{
#if EASTL_NAME_ENABLED
    get_allocator().set_name(EASTL_FIXED_VECTOR_DEFAULT_NAME);
...
template <typename T, size_t nodeCount>
inline fixed_vector<T, nodeCount>::fixed_vector(const this_type& x)
    : base_type(fixed_allocator_type(mBuffer.buffer))
{
...
template <typename T, size_t nodeCount>
inline fixed_vector<T, nodeCount>::fixed_vector(this_type&& x)
    : base_type(fixed_allocator_type(mBuffer.buffer))
{
...
template <typename T, size_t nodeCount>
inline fixed_vector<T, nodeCount>::fixed_vector(std::initializer_list<T> ilist)
    : base_type(fixed_allocator_type(mBuffer.buffer))
{
...
template <typename T, size_t nodeCount>
template <typename InputIterator>
fixed_vector<T, nodeCount>::fixed_vector(InputIterator first, InputIterator last)
    : base_type(fixed_allocator_type(mBuffer.buffer))
{
#if EASTL_NAME_ENABLED
    get_allocator().set_name(EASTL_FIXED_VECTOR_DEFAULT_NAME);
...
template <typename T, size_t nodeCount>
inline typename fixed_vector<T, nodeCount>::this_type&
fixed_vector<T, nodeCount>::operator=(const this_type& x)
{
    if(this != &x)
    {
        clear();
...
template <typename T, size_t nodeCount>
inline typename fixed_vector<T, nodeCount>::this_type&
fixed_vector<T, nodeCount>::operator=(std::initializer_list<T> ilist)
{
    typedef typename std::initializer_list<value_type>::iterator InputIterator;
    typedef typename eastl::iterator_traits<InputIterator>::iterator_category IC;
...
template <typename T, size_t nodeCount>
inline typename fixed_vector<T, nodeCount>::this_type&
fixed_vector<T, nodeCount>::operator=(this_type&& x)
{
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::swap(this_type& x)
{
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::set_capacity(size_type n)
{
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::reset_lose_memory()
{
    mpBegin = mpEnd = (value_type*)&mBuffer.buffer[0];
    internalCapacityPtr() = mpBegin + nodeCount;
}
...
template <typename T, size_t nodeCount>
inline typename fixed_vector<T, nodeCount>::size_type
fixed_vector<T, nodeCount>::max_size() const
{
    return kMaxSize;
}
...
template <typename T, size_t nodeCount>
inline bool fixed_vector<T, nodeCount>::full() const
{
...
template <typename T, size_t nodeCount>
inline void* fixed_vector<T, nodeCount>::push_back_uninitialized()
{
...
template <typename T, size_t nodeCount>
inline void* fixed_vector<T, nodeCount>::DoPushBackUninitialized(true_type)
{
...
template <typename T, size_t nodeCount>
inline void* fixed_vector<T, nodeCount>::DoPushBackUninitialized(false_type)
{
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::push_back(const value_type& value)
{
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::DoPushBack(true_type, const value_type& value)
{
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::DoPushBack(false_type, const value_type& value)
{
    EASTL_ASSERT(mpEnd < internalCapacityPtr());
...
template <typename T, size_t nodeCount>
inline typename fixed_vector<T, nodeCount>::reference fixed_vector<T, nodeCount>::push_back()
{
...
template <typename T, size_t nodeCount>
inline typename fixed_vector<T, nodeCount>::reference fixed_vector<T, nodeCount>::DoPushBack(true_type)
{
...
// In this configuration, there is no need for the heavy weight push_back() which tests to see if the container should grow (it never will)
template <typename T, size_t nodeCount>
inline typename fixed_vector<T, nodeCount>::reference fixed_vector<T, nodeCount>::DoPushBack(false_type)
{
    EASTL_ASSERT(mpEnd < internalCapacityPtr());
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::push_back(value_type&& value)
{
...
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::DoPushBackMove(true_type, value_type&& value)
{
...
// In this configuration, there is no need for the heavy weight push_back() which tests to see if the container should grow (it never will)
template <typename T, size_t nodeCount>
inline void fixed_vector<T, nodeCount>::DoPushBackMove(false_type, value_type&& value)
{
    EASTL_ASSERT(mpEnd < internalCapacityPtr());
...
template <typename T, size_t nodeCount>
inline void swap(fixed_vector<T, nodeCount>& a,
    fixed_vector<T, nodeCount>& b)
{
    // Fixed containers use a special swap that can deal with excessively large buffers.
