...
namespace eastl
{
	...
	/// 
	template <typename Allocator, typename Key, typename Value, typename ExtractKey,
	...
	class hashtable
		:   public rehash_base<RehashPolicy, hashtable<Allocator, Key, Value, ExtractKey, Equal, H1, H2, H, RehashPolicy, bCacheHashCode, bMutableIterators, bUniqueKeys> >,
	...
	public:
		...
		typedef hashtable<Allocator, Key, Value, ExtractKey, Equal, H1, H2, H,
RehashPolicy, bCacheHashCode, bMutableIterators, bUniqueKeys> this_type;
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	template <typename FowardIterator>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(FowardIterator first, FowardIterator last, size_type nBucketCount, const H1& h1, const H2& h2, const H& h, const Eq& eq, const EK& ek, const allocator_type& allocator) 
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(const this_type& x)
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(this_type&& x)
		:   rehash_base<RP, hashtable>(x),
			hash_code_base<K, V, EK, Eq, H1, H2, H, bC>(x),
			mnBucketCount(0),
			mnElementCount(0),
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::hashtable(this_type&& x, const allocator_type& allocator)
		:   rehash_base<RP, hashtable>(x),
			hash_code_base<K, V, EK, Eq, H1, H2, H, bC>(x),
			mnBucketCount(0),
			mnElementCount(0),
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline const typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::allocator_type&
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::get_allocator() const EA_NOEXCEPT
	{
		return mAllocator;
	}
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::allocator_type&
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::get_allocator() EA_NOEXCEPT
	{
		return mAllocator;
	}
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::set_allocator(const allocator_type& allocator)
	{
		mAllocator = allocator;
	}
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::this_type&
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::operator=(const this_type& x)
	{
		if(this != &x)
		{
			clear();
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::this_type&
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::operator=(this_type&& x)
	{
		if(this != &x)
		{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::this_type&
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::operator=(std::initializer_list<value_type> ilist)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::~hashtable()
	{
		clear();
		DoFreeBuckets(mpBucketArray, mnBucketCount);
	}
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoAllocateNodeFromKey(const key_type& key)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
				typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoAllocateNodeFromKey(key_type&& key)
	{
		node_type* const pNode = (node_type*)allocate_memory(mAllocator, sizeof(node_type), EASTL_ALIGN_OF(value_type), 0);
		EASTL_ASSERT_MSG(pNode != nullptr, "the behaviour of eastl::allocators that return nullptr is not defined.");
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFreeNode(node_type* pNode)
	{
		pNode->~node_type();
		EASTLFree(mAllocator, pNode, sizeof(node_type));
	}
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFreeNodes(node_type** pNodeArray, size_type n)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type**
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoAllocateBuckets(size_type n)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFreeBuckets(node_type** pBucketArray, size_type n)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::swap(this_type& x)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::rehash_policy(const rehash_policy_type& rehashPolicy)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find(const key_type& k)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find(const key_type& k) const
	{
		const hash_code_t c = get_hash_code(k);
		const size_type   n = (size_type)bucket_index(k, c, (uint32_t)mnBucketCount);
	...
	template <typename U, typename UHash, typename BinaryPredicate>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find_as(const U& other, UHash uhash, BinaryPredicate predicate)
	{
	...
	template <typename U, typename UHash, typename BinaryPredicate>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find_as(const U& other, UHash uhash, BinaryPredicate predicate) const
	{
		const hash_code_t c = (hash_code_t)uhash(other);
		const size_type   n = (size_type)(c % mnBucketCount); // This assumes we are using the mod range policy.
	...
	template <typename U>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find_as(const U& other)
	...
	template <typename U>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find_as(const U& other) const
		{ return eastl::hashtable_find(*this, other); }
		// VC++ doesn't appear to like the following, though it seems correct to me.
		// So we implement the workaround above until we can straighten this out.
		//{ return find_as(other, eastl::hash<U>(), eastl::equal_to_2<const key_type, U>()); }
	...
	template <typename A, typename K, typename V, typename EK, typename Eq, 
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator,
				typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find_range_by_hash(hash_code_t c) const
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq, 
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator,
				typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::find_range_by_hash(hash_code_t c)
	{
		const size_type start = (size_type)bucket_index(c, (uint32_t)mnBucketCount);
		node_type* const pNodeStart = mpBucketArray[start];
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::size_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::count(const key_type& k) const EA_NOEXCEPT
	{
		const hash_code_t c      = get_hash_code(k);
		const size_type   n      = (size_type)bucket_index(k, c, (uint32_t)mnBucketCount);
		size_type         result = 0;
	...
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator,
				typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::equal_range(const key_type& k)
	{
		const hash_code_t c     = get_hash_code(k);
		const size_type   n     = (size_type)bucket_index(k, c, (uint32_t)mnBucketCount);
	...
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator,
				typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::const_iterator>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::equal_range(const key_type& k) const
	{
		const hash_code_t c     = get_hash_code(k);
		const size_type   n     = (size_type)bucket_index(k, c, (uint32_t)mnBucketCount);
		node_type**       head  = mpBucketArray + n;
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type* 
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFindNode(node_type* pNode, const key_type& k, hash_code_t c) const
	{
		for(; pNode; pNode = pNode->mpNext)
		{
			if(compare(k, c, pNode))
	...
	template <typename U, typename BinaryPredicate>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type* 
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoFindNodeT(node_type* pNode, const U& other, BinaryPredicate predicate) const
	{
		for(; pNode; pNode = pNode->mpNext)
		{
	...
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(BoolConstantT, Args&&... args) // true_type means bUniqueKeys is true.
	{
	...
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(BoolConstantT, Args&&... args) // false_type means bUniqueKeys is false.
	{
		const eastl::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t)mnBucketCount, (uint32_t)mnElementCount, (uint32_t)1);
	...
	template <class... Args>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoAllocateNode(Args&&... args)
	{
		node_type* const pNode = (node_type*)allocate_memory(mAllocator, sizeof(node_type), EASTL_ALIGN_OF(value_type), 0);
		EASTL_ASSERT_MSG(pNode != nullptr, "the behaviour of eastl::allocators that return nullptr is not defined.");
	...
	template <typename BoolConstantT>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValueExtra(BoolConstantT, const key_type& k,
	...
	template <typename BoolConstantT>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(BoolConstantT, value_type&& value, ENABLE_IF_TRUETYPE(BoolConstantT)) // true_type means bUniqueKeys is true.
	{
	...
	template <typename BoolConstantT>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValueExtra(BoolConstantT, const key_type& k, hash_code_t c, node_type* pNodeNew, value_type&& value, 
	...
	template<typename BoolConstantT>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(BoolConstantT, value_type&& value, DISABLE_IF_TRUETYPE(BoolConstantT)) // false_type means bUniqueKeys is false.
	{
		const key_type&   k = mExtractKey(value);
		const hash_code_t c = get_hash_code(k);
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoAllocateNode(value_type&& value)
	{
		node_type* const pNode = (node_type*)allocate_memory(mAllocator, sizeof(node_type), EASTL_ALIGN_OF(value_type), 0);
		EASTL_ASSERT_MSG(pNode != nullptr, "the behaviour of eastl::allocators that return nullptr is not defined.");
	...
	template<typename BoolConstantT>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValueExtra(BoolConstantT, const key_type& k, hash_code_t c, node_type* pNodeNew, const value_type& value, 
	...
	template<typename BoolConstantT>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(BoolConstantT, const value_type& value, ENABLE_IF_TRUETYPE(BoolConstantT)) // true_type means bUniqueKeys is true.
	{
		const key_type&   k = mExtractKey(value);
		const hash_code_t c = get_hash_code(k);
	...
	template<typename BoolConstantT>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertValue(BoolConstantT, const value_type& value, DISABLE_IF_TRUETYPE(BoolConstantT)) // false_type means bUniqueKeys is false.
	{
		const key_type&   k = mExtractKey(value);
		const hash_code_t c = get_hash_code(k);
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoAllocateNode(const value_type& value)
	{
		node_type* const pNode = (node_type*)allocate_memory(mAllocator, sizeof(node_type), EASTL_ALIGN_OF(value_type), 0);
		EASTL_ASSERT_MSG(pNode != nullptr, "the behaviour of eastl::allocators that return nullptr is not defined.");
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::node_type*
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::allocate_uninitialized_node()
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::free_uninitialized_node(node_type* pNode)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertKey(true_type, const key_type& key, const hash_code_t c) // true_type means bUniqueKeys is true.
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertKey(false_type, const key_type& key, const hash_code_t c) // false_type means bUniqueKeys is false.
	{
		const eastl::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t)mnBucketCount, (uint32_t)mnElementCount, (uint32_t)1);
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
				typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertKey(true_type, key_type&& key, const hash_code_t c) // true_type means bUniqueKeys is true.
	{
		size_type         n     = (size_type)bucket_index(key, c, (uint32_t)mnBucketCount);
		node_type* const  pNode = DoFindNode(mpBucketArray[n], key, c);
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
				typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoInsertKey(false_type, key_type&& key, const hash_code_t c) // false_type means bUniqueKeys is false.
	{
		const eastl::pair<bool, uint32_t> bRehash = mRehashPolicy.GetRehashRequired((uint32_t)mnBucketCount, (uint32_t)mnElementCount, (uint32_t)1);
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
				typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	template <class... Args>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::emplace(Args&&... args)
	{
	...
	template <class... Args>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::emplace_hint(const_iterator, Args&&... args)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
	          typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	template <class... Args>
	// inline eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::try_emplace(const key_type& key, Args&&... args)
	{
	...
	// inline eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::try_emplace(key_type&& key, Args&&... args)
	{
	...
	template <class... Args>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::try_emplace(const_iterator, const key_type& key, Args&&... args)
	{
	...
	template <class... Args>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::try_emplace(const_iterator, key_type&& key, Args&&... args)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(value_type&& otherValue)
	{
	...
	template <class P>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(hash_code_t c, node_type* pNodeNew, P&& otherValue)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(const_iterator, value_type&& value)
	{
		// We currently ignore the iterator argument as a hint.
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(const value_type& value) 
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(hash_code_t c, node_type* pNodeNew, const value_type& value) 
	{
		// pNodeNew->mValue is expected to be uninitialized.
		const key_type& k = mExtractKey(value);
	...
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_return_type
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(P&& otherValue)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(const_iterator, const value_type& value)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(std::initializer_list<value_type> ilist)
	{
		insert(ilist.begin(), ilist.end());
	}
	...
	void
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert(InputIterator first, InputIterator last)
	{
	...
	template <class M>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_or_assign(const key_type& k, M&& obj)
	{
		auto iter = find(k);
		if(iter == end())
		{
	...
	template <class M>
	eastl::pair<typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator, bool>
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_or_assign(key_type&& k, M&& obj)
	{
		auto iter = find(k);
		if(iter == end())
		{
	...
	template <class M>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator 
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_or_assign(const_iterator, const key_type& k, M&& obj)
	{
	...
	template <class M>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator 
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::insert_or_assign(const_iterator, key_type&& k, M&& obj)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::erase(const_iterator i)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::iterator
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::erase(const_iterator first, const_iterator last)
	{
		while(first != last)
			first = erase(first);
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	typename hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::size_type 
	hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::erase(const key_type& k)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::clear()
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::clear(bool clearBuckets)
	{
		DoFreeNodes(mpBucketArray, mnBucketCount);
		if(clearBuckets)
		{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::reset_lose_memory() EA_NOEXCEPT
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::reserve(size_type nElementCount)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::rehash(size_type nBucketCount)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	void hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::DoRehash(size_type nNewBucketCount)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline bool hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::validate() const
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	int hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>::validate_iterator(const_iterator i) const
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline bool operator<(const hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>& a, 
						  const hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>& b)
	{
	...
	template <typename A, typename K, typename V, typename EK, typename Eq,
			  typename H1, typename H2, typename H, typename RP, bool bC, bool bM, bool bU>
	inline void swap(const hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>& a, 
					 const hashtable<A, K, V, EK, Eq, H1, H2, H, RP, bC, bM, bU>& b)
	{
		a.swap(b);
	}
