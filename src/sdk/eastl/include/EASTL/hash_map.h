...
namespace eastl
{
	...
	///
	template <typename Allocator, typename Key, typename T, typename Hash = eastl::hash<Key>, 
		typename Predicate = eastl::equal_to<Key>, bool bCacheHashCode = false>
	class hash_map
		: public hashtable<Allocator, Key, eastl::pair<const Key, T>, eastl::use_first<eastl::pair<const Key, T> >, Predicate, Hash, mod_range_hashing, default_ranged_hash, prime_rehash_policy, bCacheHashCode, true, true>
	{
	public:
		typedef hashtable<Allocator, Key, eastl::pair<const Key, T>,
			eastl::use_first<eastl::pair<const Key, T> >, Predicate, 
			Hash, mod_range_hashing, default_ranged_hash, prime_rehash_policy, bCacheHashCode, true, true> base_type;
		typedef hash_map<Allocator, Key, T, Hash, Predicate, bCacheHashCode> this_type;
	...
	template <typename Allocator, typename Key, typename T, typename Hash = eastl::hash<Key>, 
		typename Predicate = eastl::equal_to<Key>, bool bCacheHashCode = false>
	class hash_multimap : public hashtable<Allocator, Key, eastl::pair<const Key, T>, 
		eastl::use_first<eastl::pair<const Key, T> >, Predicate, Hash, mod_range_hashing, 
		default_ranged_hash, prime_rehash_policy, bCacheHashCode, true, false>
	{
	public:
		typedef hashtable<Allocator, Key, eastl::pair<const Key, T>,
		...
		typedef hash_multimap<Allocator, Key, T, Hash, Predicate, bCacheHashCode> this_type;
		typedef typename base_type::size_type size_type;
		typedef typename base_type::key_type key_type;
		typedef T mapped_type;
	...
	template <typename Allocator, typename Key, typename T, typename Hash, typename Predicate, bool bCacheHashCode, typename UserPredicate>
	void erase_if(eastl::hash_multimap<Allocator, Key, T, Hash, Predicate, bCacheHashCode>& c, UserPredicate predicate)
	{
		// Erases all elements that satisfy the predicate from the container.
		for (auto i = c.begin(), last = c.end(); i != last;)
		{
	...
	template <typename Allocator, typename Key, typename T, typename Hash, typename Predicate, bool bCacheHashCode>
	inline bool operator==(const hash_map<Allocator, Key, T, Hash, Predicate, bCacheHashCode>& a,
						   const hash_map<Allocator, Key, T, Hash, Predicate, bCacheHashCode>& b)
	{
	...
	template <typename Allocator, typename Key, typename T, typename Hash, typename Predicate, bool bCacheHashCode>
	inline bool operator!=(hash_map<Allocator, Key, T, Hash, Predicate, bCacheHashCode>& a, 
						   hash_map<Allocator, Key, T, Hash, Predicate, bCacheHashCode>& b)
	{
		return !(a == b);
	}
	...
	template <typename Allocator, typename Key, typename T, typename Hash, typename Predicate, bool bCacheHashCode>
	inline bool operator==(const hash_multimap<Allocator, Key, T, Hash, Predicate, bCacheHashCode>& a,
						   const hash_multimap<Allocator, Key, T, Hash, Predicate, bCacheHashCode>& b)
	{
