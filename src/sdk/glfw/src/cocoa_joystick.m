...
static void closeJoystick(_GLFWjoystick* js)
{
    ...
    for (i = 0;  i < CFArrayGetCount(js->ns.axes);  i++)
        _glfwFree((void*) CFArrayGetValueAtIndex(js->ns.axes, i));
    CFRelease(js->ns.axes);

    for (i = 0;  i < CFArrayGetCount(js->ns.buttons);  i++)
        _glfwFree((void*) CFArrayGetValueAtIndex(js->ns.buttons, i));
    CFRelease(js->ns.buttons);

    for (i = 0;  i < CFArrayGetCount(js->ns.hats);  i++)
        _glfwFree((void*) CFArrayGetValueAtIndex(js->ns.hats, i));
                          ...
                          IOHIDDeviceRef device)
{
    ...
    for (i = 0;  i < CFArrayGetCount(elements);  i++)
    {
        ...
        if (target)
        {
            _GLFWjoyelementNS* element = _glfwCalloc(1, sizeof(_GLFWjoyelementNS));
