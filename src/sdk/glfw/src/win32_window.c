                                   ...
                                   WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsg)
    {
        ...
        case WM_INPUT:
        {
            ...
            {
                _glfwFree(_glfw.win32.rawInput);
                _glfw.win32.rawInput = _glfwCalloc(size, 1);
        ...
        case WM_DROPFILES:
        {
            ...
            char** paths = _glfwCalloc(count, sizeof(char*));
            ...
            for (i = 0;  i < count;  i++)
            {
                ...
                WCHAR* buffer = _glfwCalloc(length + 1, sizeof(WCHAR));
