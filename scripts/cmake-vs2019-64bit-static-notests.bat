...
mkdir %BUILD_ROOT%
pushd %BUILD_ROOT%
%CMAKE_PATH%\bin\cmake.exe -G "Visual Studio 16 2019" -DWITH_EDITOR=1 -DPHYSX_DIR="%PHYSX_DIR%\install\vc15win64" -DVK_SDK_PATH="%VK_SDK_PATH%" --check-system-vars %ROOTDIR%
popd
pause
endlocal